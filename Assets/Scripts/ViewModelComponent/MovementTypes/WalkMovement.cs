...
public class WalkMovement : Movement
{
    ...
    {
        // TODO: Allow jumping from height
        // maybe add damage from fall
    ...
    public override IEnumerator Traverse(Tile tile)
    {
        ...
        // Build a list of way points from starting tile
        // to destination tile
    ...
    {
        Tweener tweener = transform.MoveTo(
            target.center, 0.5f, EasingEquations.Linear
        );
        while(tweener != null)
            yield return null;
    }
    ...
    {
        Tweener tweener = transform.MoveTo(
            to.center, 0.5f, EasingEquations.Linear
        );
        Tweener t2 = jumper.MoveToLocal(
